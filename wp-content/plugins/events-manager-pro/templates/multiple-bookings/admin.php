				...
				<div class="inside">
					...
					<div>
						...
						<form action="" method="post" class="em-booking-single-status-edit">
							...
							<br /><em><?php echo wp_kses_data(__emp('<strong>Notes:</strong> Ticket availability not taken into account when approving new bookings (i.e. you can overbook).','events-manager')); ?></em>
							</p>
						</form>
					</div>
