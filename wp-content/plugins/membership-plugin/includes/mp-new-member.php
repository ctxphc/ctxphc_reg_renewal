	...
	<form class="memb_reg_form" id="regForm" name="regForm" method="post" action="<?php plugins_url( 'add-new-member.php', __FILE__ ); ?>">
		...
		<fieldset class="reg_form" id=personal_info>
			...
			<div class="reg_renewal_row">
				...
				<select class="reg_birth_month validate[required, custom[onlyNumber]]" id="memb_month"
		...
		<fieldset class="reg_form" id="spouse_info">
			...
			<div class="reg_renewal_row">
				...
				<select class="reg_birth_month validate[required, custom[onlyNumber]]" id="sp_month"
			...
			<div class="reg_renewal_row">
				...
				<label class="reg_relationship" id="sp_relationship" for="sp_relationship">Relationship:</label>
				<select id="sp_relationship" class="reg_relationship validate[required]" name="sp_relationship">
		...
		<fieldset class="reg_form" id=family_info>
			...
			<section id="child1">
				...
				<div class="reg_renewal_row">
					...
					<select class="reg_birth_month validate[custom[onlyNumber]]" data-prompt-position="bottomLeft"
			...
			<section id="child2">
				...
				<div class="reg_renewal_row">
					...
					<select class="reg_birth_month" id=c2_month name=c2_month>
						<option value="MM" selected="selected">MM</option>
						<?php for ( $m = 1; $m <= 12; $m ++ ) {
			...
			<section id="child3">
				...
				<div class="reg_renewal_row">
					...
					<select class="reg_birth_month" id=c3_month name=c3_month>
						<option value="MM" selected="selected">MM</option>
						<?php for ( $m = 1; $m <= 12; $m ++ ) {
			...
			<section id="child4">
				...
				<div class="reg_renewal_row">
					...
					<select class="reg_birth_month" id=c4_month name=c4_month>
						<option value="MM" selected="selected">MM</option>
						<?php for ( $m = 1; $m <= 12; $m ++ ) {
