...
<div class="wrap about-wrap">
    ...
    <div class="about-text"><?php _e( "Displays a list of all registered attendees for the $curr_year Pirate's Ball." ); ?></div>
    <div class="wp-badge"><?php printf( __( '%s' ), $curr_year ); ?></div>

	<h2><?php _e( "CTXPHC Pirate's Ball Registered Attendees" ); ?></h2>
	...
	<div class="changelog">
	    ...
	    <h3><?php _e( "$curr_year Pirate's Ball Attendees" ); ?></h3>

	    <div class="feature-section images-stagger-right">
		<img src="<?php echo esc_url( admin_url( 'images/pb-badge.jpg' ) ); ?>" class="image-50" />
