			...
			<fieldset class="reg_form" id="family_info">
				...
				<section id="child1">
					<div class="reg_form_row">
						...
						<input class="reg_last_name validate[custom[onlyLetterSp]]"
						       ...
						       value=""/></div>
					<div class="reg_form_row">
						<label class="reg_birthday" id="lbl_c_birthday" for="c1_birthday">Birthdate:</label>
				...
				<section id="child2">
					...
					<div class="reg_form_row">
						...
						<input class="reg_birthday" id="c2_birthday" name="c2_birthday" type="date"/>
				...
				<section id="child3">
					...
					<div class="reg_form_row">
						...
						<input class="reg_birthday" id="c3_birthday" name="c3_birthday" type="date"/>
				...
				<section id="child4">
					...
					<div class="reg_form_row">
						...
						<input class="reg_birthday" id="c4_birthday" name="c4_birthday" type="date"/>
