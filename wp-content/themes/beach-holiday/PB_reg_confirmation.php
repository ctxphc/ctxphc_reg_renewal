...
<div id="content"><div class="spacer"></div>
  <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
    ...
    <div class="entry">
	 ...
	 <div>
	   <h2 style="text-align: center;"><img id='PB_logo'alt="CTXPHC Pirate's Ball 2013 Logo" src="http://www.ctxphc.com/wp-content/Images/Pirates_Ball/Pirates_BallLogo-2013.jpg" width="320" height="203" /></h2>
	 </div>
