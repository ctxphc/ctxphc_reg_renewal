...
function mp_membership_status_widget() {
	require_once( dirname( __FILE__ ) . 'includes/mp-membership-count-widget.php' );
}

function mp_membership_reports() {
	require_once( dirname( __FILE__ ) . 'includes/mp-membership-reports-widget.php' );
}

function mp_newest_members() {
	require_once( dirname( __FILE__ ) . 'includes/mp-newest-members-widget.php' );
} // end add Newest Members widget

function mp_next_months_birthdays() {
	require_once( dirname( __FILE__ ) . 'includes/mp-next-months-birthdays-widget.php' );
}