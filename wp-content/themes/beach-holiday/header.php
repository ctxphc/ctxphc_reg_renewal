...
<head profile="http://gmpg.org/xfn/11">
    ...
    <link rel="alternate" type="application/rss+xml" title="<?php bloginfo( 'name' ); ?> RSS Feed"
          href="<?php echo ( ! empty( $tpinfo[ 'templatelite_feedurl' ] ) ) ? $tpinfo[ 'templatelite_feedurl' ] : bloginfo( 'rss2_url' ); ?>"/>
        ...
        <div id="base">
            <div id="base_btm">
                <div id="header">
					...
					?>
                    <<?php echo $tmp; ?> id="blog_name"<?php echo $tmp2; ?>><a
                ...
                <form class="mainsearch" action="<?php bloginfo( 'url' ); ?>/" method="get">
                    <input class="keyword" type="text" name="s" id="s" value="Search ..."
            ...
            <div id="container">
                <a href="<?php echo ( ! empty( $tpinfo[ 'templatelite_feedurl' ] ) ) ? $tpinfo[ 'templatelite_feedurl' ] : bloginfo( 'rss2_url' ); ?>"
                   title="RSS Feed" class="rss"></a>
