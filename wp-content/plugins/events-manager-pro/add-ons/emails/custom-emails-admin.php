			...
			'default' => array(
				...
				'subgroups' => array(
					'admin'=>array(
						...
						'emails' => array(
							0 => array('title'=> __emp('Pending booking email','events-manager')),
							1 => array('title'=> __emp('Confirmed booking email','events-manager')),
							3 => array('title'=> __emp('Booking cancelled','events-manager'))
						)
					),
					'user'=>array(
						...
						'emails' => array(
							0 => array('title'=> __emp('Pending booking email','events-manager')),
							1 => array('title'=> __emp('Confirmed booking email','events-manager')),
							2 => array('title'=> __emp('Rejected booking email','events-manager')),
							3 => array('title'=> __emp('Booking cancelled','events-manager'))
						)
					)
				)
