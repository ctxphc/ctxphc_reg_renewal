...
?>
	...
	<form class="memb_reg_form" id="regForm" name="regForm" method="post" action="<?php plugins_url( 'cm-add-new-member.php', __FILE__ ); ?>">
		...
		<fieldset class="reg_form" id=personal_info>
			...
			<div class="reg_renewal_row">
				<label class="cm_birthday" id="memb_birthday" for="b-day">Birthdate:</label>
		...
		<fieldset class="reg_form" id="spouse_info">
			...
			<div class="reg_renewal_row">
				<label class="cm_birthday" id="sp_birthday" for="spouseb-day">Birthdate:</label>
		...
		<fieldset class="reg_form" id=family_info>
			...
			<section id="child1">
				...
				<div class="reg_renewal_row">
					<label class="cm_birthday" id=child1b-day for=child1b-day>Birthdate:</label>
			...
			<section id="child2">
				...
				<div class="reg_renewal_row">
					<label class="cm_birthday" id=child2b-day for=child2b-day>Birthdate:</label>
			...
			<section id="child3">
				...
				<div class="reg_renewal_row">
					<label class="cm_birthday" id=child3b-day for=child3b-day>Birthdate:</label>
			...
			<section id="child4">
				...
				<div class="reg_renewal_row">
					<label class="cm_birthday" id=child4b-day for=child4b-day>Birthdate:</label>
