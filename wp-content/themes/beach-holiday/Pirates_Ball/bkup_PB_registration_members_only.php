...
$args[ 'expiry' ]   = $expiry = new DateTime( "May 31, 2015 23:59:00" );
$args[ 'expiry2' ]  = $expiry2 = new DateTime( "July 25, 2015 23:59:00" );
			...
			<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
				...
				<div class="entry">
					...
					<div class="pb_header">
						...
						<h2 class="pb_center <?php echo $pb_memb_class; ?>" id="memb_reg">Members Only Early
						Registration</h2>
					...
					<div>
						<img id='PB_logo'
						     ...
						     src="<?php echo get_template_directory_uri(); ?>/images/Pirates_Ball/2015 Pirate's Ball Logo.jpg"
						     width="300"
							/>
					</div>
					<div class="pb_cost <?php echo $pb_memb_class; ?>" id="memb_reg_cost">
						<h4 class="pb_center pb_header">CTXPHC Members only early registration cost: $<?php echo $pb_memb_cost; ?> per
							person</h4>
						<ul>
