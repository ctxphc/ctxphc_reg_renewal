...
<div class="wrap about-wrap">
	...
	<a href="<?php plugins_url( 'ctxphc-renewal-dashboard.php', __FILE__ ) ?>" class="nav-tab nav-tab-active">
	    <?php _e( 'Waiting' ); ?>
	</a>
	<a href="<?php plugins_url( 'ctxphc-renewals-pending.php', __FILE__ ) ?>" class="nav-tab">
	    <?php _e( 'Pending' ); ?>
	</a>
    ...
    <div class="changelog">
	<h3><?php _e( 'Members Needing To Renew' ); ?></h3>
