 ...
 */
class MP_Active_Members_List_Table extends MP_List_Table {
	...
	public function current_action() {
		if ( isset( $_REQUEST[ 'changeit' ] ) && ! empty( $_REQUEST[ 'new_role' ] ) ) {
			return 'promote';
		} elseif ( isset( $_REQUEST[ 'archive' ] ) && ! empty( $_REQUEST[ 'member' ] ) ) {
			return 'archive';
		}
	...
	public function single_row( $user_object, $style = '', $role = '', $numposts = 0 ) {
		...
		if ( $this->is_site_users ) {
			$url = "site-admin.php?id={$this->site_id}&amp;";
		} else {
			$url = 'admin.php?';
		}
		...
		if ( current_user_can( 'list_users' ) ) {
			...
			if ( current_user_can( 'edit_user', $user_object->ID ) ) {
				...
				$archive              = "<strong><a href=\"$archive_link\">$user_object->user_login</a></strong><br />";
