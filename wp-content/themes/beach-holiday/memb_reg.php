    ...
    <div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
      ...
      <div class="entry">
        ...
        <div>
          ...
          <div class="warning">Currently our registration form is not working correctly. We are aware of this issue
            and are actively working to resolve this as quick as possible. In the mean time please contact our <a
                href="mailto:<?php echo antispambot( 'membership@ctxphc.com' ); ?> ">Membership Director</a> and
        ...
        <p class="ctxphc_reg_txt">So, you've decided you want to join in our mission to Party with a Purpose,
          have PHun and help the community? If so, <img class="alignright wp-image-7" title="membership-image"
                                                        ...
                                                        alt="ctxphc membership image"/>you can complete the
          application below and make a payment using PayPal or print out the application and mail a check to:</p>
        ...
        <p class="ctxphc_reg_txt">Membership entitles you to attend our numerous monthly events; an official club
          badge; access to the monthly CTXPHC newsletter and ParrotHead-related electronic bulletins. The
          newsletter and bulletins keep you up-to-date regarding local, regional and statewide PHlockings (which
          you would be eligible to attend); community events; special discounts; concert news; VIP passes and much
          more!</p>
        ...
        <p class="ctxphc_reg_txt">If you are ready to join in the PHun, scroll down and fill out our registration
          form!</p>

        <p class="ctxphc_reg_txt"><strong>NOTE: If this is a renewal, login to your profile and click on the "Renew
            Membership" button. If you don't know how to login, send email to the <a
                href="mailto:<?php echo antispambot( 'support@ctxphc.com' ); ?>">CTXPHC Support Staff</a>.</strong>
        </p>
          ...
          <fieldset class="reg_form" id="family_info">
            ...
            <section id="child2">
              ...
              <div class="reg_form_row">
                ...
                <input class="cm_birthday validate[custom[dateFormat]]" id="c2_birthday" name="c2_birthday"
                       type="date"/>
            ...
            <section id="child3">
              ...
              <div class="reg_form_row">
                ...
                <input class="cm_birthday validate[custom[dateFormat]]" id="c3_birthday" name="c3_birthday"
                       type="date"/>
            ...
            <section id="child4">
              ...
              <div class="reg_form_row">
                ...
                <input class="cm_birthday validate[custom[dateFormat]]" id="c4_birthday" name="c4_birthday"
                       type="date"/>
